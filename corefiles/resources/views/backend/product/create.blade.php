                            ...
                            <div class="col-lg-6">
                                ...
                                <form action="{{route('product.store')}}" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="file" id="product-image" class="form-control" name="photo" required>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="product-price" name="purchase_price" placeholder="Purchase Price" required>
                                    ...
                                    <div class="form-group mb-3">
                                        <label for="product-price">Rent Price <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="product-price" name="sales_price" placeholder="Rent price" required>
